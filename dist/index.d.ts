...
declare const DefaultUI: {
    ...
    Tooltip: ({ labels }: TooltipProps) => JSX.Element;
};

export { CopilotOptions as CopilotProps, CopilotProvider, CopilotStep, DefaultUI, TooltipProps, useCopilot, walkthroughable };
